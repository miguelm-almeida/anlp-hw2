...
def crawl_website(start_url, max_pages=100):
    ...
    output_dir = f'raw-data/general-and-history/{domain_dir}'
...
def crawl_multiple_sites(urls, max_pages_per_site=50):
    ...
    os.makedirs('raw-data/general-and-history', exist_ok=True)
...
print(f"Results saved to the 'raw-data/general-and-history' directory")