...
def main():
    parser = argparse.ArgumentParser(description='Process and clean text files from events and sports directory.')
    parser.add_argument('--output', default='clean-data/general-and-history.txt',
                        help='Path to the output file (default: clean-data/general-and-history.txt)')
    parser.add_argument('--input', default='raw-data/general-and-history',
                        help='Path to the input directory (default: raw-data/general-and-history)')
