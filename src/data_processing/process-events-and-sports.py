...
def main():
    ...
    parser.add_argument('--output', default='clean-data/events-and-sports.txt',
                        help='Path to the output file (default: clean-data/events-and-sports.txt)')
    parser.add_argument('--input', default='raw-data/events-and-sports',
                        help='Path to the input directory (default: raw-data/events-and-sports)')
