...
def crawl_website(start_url, max_pages=100):
    ...
    output_dir = f'raw-data/events-and-sports/{domain_dir}'
...
def crawl_multiple_sites(urls, max_pages_per_site=50):
    ...
    os.makedirs('raw-data/events-and-sports', exist_ok=True)
...
print(f"Results saved to the 'raw-data/events-and-sports' directory")